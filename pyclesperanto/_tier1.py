...
def minimum_distance_of_touching_neighbors(
    ...
    Image
    """
    return _get_backend()._minimum_distance_of_touching_neighbors(device, input_image_distance_matrix, input_image_touch_matrix, output_image_index_list)
