...
@deprecated('maximum_sphere: This function is deprecated. Consider using maximum() instead.')
...
@deprecated('minimum_sphere: This function is deprecated. Consider using minimum() instead.')
@plugin_function(categories=["filter", "in assistant", "bia-bob-suggestion"])
def minimum_sphere(
    input_image: Image,
    output_image: Optional[Image] =None,
...
@deprecated('average_distance_touching_neighbors: This function is deprecated. Consider using mean_distance_of_touching_neighbors() instead.')
@plugin_function
