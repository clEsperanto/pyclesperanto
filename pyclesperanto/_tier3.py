...
def generate_touching_area_matrix(
    ...
    Image
    """
    return _get_backend()._generate_touching_area_matrix(device, input_image_label, output_image_matrix)

@warnings.deprecated('generate_touch_count_matrix: This function is deprecated. Consider using generate_touch_matrix() with an explicit dst_matrix argument instead.')
@plugin_function
def generate_touch_count_matrix(
    ...
    Image
    """
    return _get_backend()._generate_touch_count_matrix(device, input_image_label, output_image_matrix)
...
def labels_statistics(
    ...
    dict
    """
    return _get_backend()._labels_statistics(device, label, intensity, include_background)

@warnings.deprecated('statistics_of_labelled_pixels: This function is deprecated. Consider using labels_statistics() instead.')
@plugin_function
...
@warnings.deprecated('statistics_of_background_and_labelled_pixels: This function is deprecated. Consider using labels_statistics() instead.')
@plugin_function
...
@warnings.deprecated('read_intensities_from_map: This function is deprecated. Consider using read_map_values() instead.')
@plugin_function
...
__all__ = ["bounding_box", "center_of_mass", "clahe", "remove_labels", "exclude_labels", "remove_labels_on_edges", "exclude_labels_on_edges", "flag_existing_labels", "gamma_correction", "generate_binary_overlap_matrix", "generate_touch_matrix", "generate_touching_area_matrix", "generate_touch_count_matrix", "histogram", "jaccard_index", "labelled_spots_to_pointlist", "maximum_position", "mean_of_all_pixels", "minimum_position", "morphological_chan_vese", "labels_statistics", "statistics_of_labelled_pixels", "statistics_of_background_and_labelled_pixels", "sato_filter", "tubeness", "artificial_tissue", "read_map_values", "read_intensities_from_map"]