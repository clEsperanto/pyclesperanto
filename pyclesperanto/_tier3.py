...
@deprecated('generate_touch_count_matrix: This function is deprecated. Consider using generate_touch_matrix() with an explicit dst_matrix argument instead.')
@plugin_function
...
@deprecated('statistics_of_labelled_pixels: This function is deprecated. Consider using labels_statistics() instead.')
@plugin_function
...
@deprecated('statistics_of_background_and_labelled_pixels: This function is deprecated. Consider using labels_statistics() instead.')
@plugin_function
...
@deprecated('read_intensities_from_map: This function is deprecated. Consider using read_map_values() instead.')
@plugin_function
