...
@deprecated('label_mean_intensity_map: This function is deprecated. Use mean_intensity_map_func instead.')
@plugin_function(categories=["label measurement", "map", "in assistant", "combine"])
...
@deprecated('label_pixel_count_map: This function is deprecated. Use pixel_count_map_func instead.')
@plugin_function(categories=["label measurement", "map", "in assistant"])
...
@deprecated('exclude_labels_with_map_values_out_of_range: This function is deprecated. Use remove_labels_with_map_values_out_of_range_func instead.')
@plugin_function(categories=["label processing", "combine"])
...
@deprecated('exclude_labels_with_map_values_within_range: This function is deprecated. Use remove_labels_with_values_within_range_func instead.')
@plugin_function(categories=["label processing", "combine"])
...
def standard_deviation_of_all_pixels(
    ...
    float
    """
    return _get_backend()._standard_deviation_of_all_pixels(device, input_image)
