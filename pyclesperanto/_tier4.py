...
def parametric_map(
    ...
    """
    return _get_backend()._parametric_map(device, labels, intensity, str(property), output_image)
...
@warnings.deprecated('label_mean_intensity_map: This function is deprecated. Use mean_intensity_map_func instead.')
@plugin_function(categories=["label measurement", "map", "in assistant", "combine"])
...
@warnings.deprecated('label_pixel_count_map: This function is deprecated. Use pixel_count_map_func instead.')
@plugin_function(categories=["label measurement", "map", "in assistant"])
...
@warnings.deprecated('exclude_labels_with_map_values_out_of_range: This function is deprecated. Use remove_labels_with_map_values_out_of_range_func instead.')
@plugin_function(categories=["label processing", "combine"])
...
@warnings.deprecated('exclude_labels_with_map_values_within_range: This function is deprecated. Use remove_labels_with_values_within_range_func instead.')
@plugin_function(categories=["label processing", "combine"])
...
@warnings.deprecated('generate_touch_portion_matrix: This function is deprecated. Use generate_partial_touching_area_matrix() instead.')
@plugin_function
