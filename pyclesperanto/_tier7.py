...
def labels_neighbors_statistics(
    ...
    dict
    """
    return _get_backend()._labels_neighbors_statistics(device, label, proximal_distances, nearest_neighbor_ns, dilation_radii)

@warnings.deprecated('statistics_of_labelled_neighbors: This function is deprecated. Consider using statistics_of_neighbor_labels() instead.')
@plugin_function
